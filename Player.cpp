#include "Player.h"
#include "Arena.h"
#include "Previous.h"//should include as we can't assume arena.h includes it
#include "globals.h" //should include as we can't assume arena.h includes it
#include<iostream>
using namespace std;
///////////////////////////////////////////////////////////////////////////
...
{
    m_age++;
    m_arena->thePrevious().dropACrumb(this->row(),this->col());//HOW WE UPDATE THE PREVIOIUS OBJECT IN ARENA CLASS
}
